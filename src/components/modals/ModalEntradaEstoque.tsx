...
const ModalEntradaEstoque: React.FC<Props> = ({ open, defaultNome = '', onClose, onConfirm }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="w-full max-w-md rounded-lg bg-white shadow-xl">
        <div className="px-5 py-4 border-b">
          <h2 className="text-lg font-semibold">Lançar entrada no estoque</h2>
        </div>
        ...
        <div className="px-5 py-4 space-y-3">
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-pink-500"
